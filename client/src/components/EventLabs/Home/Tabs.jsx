    ...
    <div className="w-screen h-auto relative">
      <BoxWrapper bgcolor="white" direction="row">
        <div className="w-full p-2 xl:w-[51%] flex flex-col justify-end">
          <h2 className="font-bold text-2xl xl:text-7xl">
            Breaking down event management software into essentials
          </h2>
          <div className="text-lg w-full xl:text-3xl mt-10 xl:w-3/4">
      ...
      <BoxWrapper bgcolor="Black" direction="row-reverse" textColor="White">
        <div className="w-screen xl:w-1/2 p-9">
          <h2 className="font-bold text-3xl xl:text-7xl">
            Breaking down event management software into essentials
          </h2>
          <div className="text-lg xl:text-3xl mt-10 w-full xl:w-3/4">
            Often, ticketing and registration software are mistaken for event
            management software. However, modern EMS tools are holistic
            solutions that can house them along with other event management
            necessities in a single console. They often include the following:
      ...
      <BoxWrapper bgcolor="white" direction="row">
        <h2 className="absolute top-2 xl:top-10 text-4xl xl:text-7xl font-bold ">
          Features
        </h2>
        <div className="w-full flex flex-col xl:flex-row flex-wrap justify-between mt-9 xl:mt-0 ">
          <div className="my-6 w-screen xl:w-[49%] px-6 justify-center items-center mt-4 flex flex-row flex-wrap xl:flex-row-reverse ">
            <span className="h-[200px]">
              <img src={FBanner} alt="" className="h-full w-full" />
            </span>
            <span className="text-md xl:text-2xl w-screen xl:w-[70%] font-medium mx-5">
      ...
      <BoxWrapper bgcolor="Black" direction="row-reverse" textColor="White">
        <div className="flex flex-wrap items-center flex-row-reverse justify-around w-[90%]">
          <div className="w-full my-4 md:w-1/5 relative p-5 backdrop-blur-md bg-[#3B3E44] rounded-xl">
            <img
              src={Kaustav}
              className="rounded-full border-black w-3/5 md:w-4/5 m-auto"
              alt="Kaustav"
            />
            <div className="text-xl xl:text-3xl m-auto text-center my-5">
              Kaustav Giri
            </div>
            <div className="text-xl xl:text-4xl m-auto my-4 text-center">
              Front End Developer
            </div>
            <div className="flex justify-between xl:w-2/4 my-5 m-auto items-center">
              <span className="px-4 py-3 rounded-full bg-[#ffffff] flex items-center justify-center">
                <FontAwesomeIcon
                  className="text-2xl xl:text-4xl text-[#000000]"
                  icon={faLinkedinIn}
                />
              </span>
        ...
        <div className="relative xl:absolute mt-4 bottom-4 w-full flex flex-col xl:flex-row items-center justify-center text-xl xl:text-4xl">
